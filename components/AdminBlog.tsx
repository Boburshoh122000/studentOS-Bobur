...
import { ArrowLeft, Bell, Briefcase, CheckCircle, ChevronLeft, ChevronRight, CreditCard, FileText, GraduationCap, Hourglass, Image, LayoutDashboard, LogOut, NotebookPen, Pencil, Plus, Search, ShieldCheck, Trash2, TrendingUp, Users, X } from 'lucide-react';
              ...
              <section className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div className="flex flex-col gap-1 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#1e2330] p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center justify-between">
                    ...
                    <FileText size={20} className="text-primary text-primary dark:text-primary-dark" />
                  </div>
                ...
                <div className="flex flex-col gap-1 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-[#1e2330] p-5 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center justify-between">
                    ...
                    <NotebookPen size={20} className="text-orange-500" />
                  </div>
                  <p className="mt-2 text-2xl font-bold text-slate-900 dark:text-white">
