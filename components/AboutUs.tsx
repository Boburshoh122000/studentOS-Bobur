      ...
      <div className="relative flex h-auto min-h-screen w-full flex-col group/design-root">
        <header className="fixed top-0 z-50 w-full bg-white/80 dark:bg-[#111421]/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 h-20 transition-all duration-200">
          <div className="mx-auto flex h-full max-w-7xl items-center justify-between px-6 lg:px-8">
            <div
              className="flex items-center gap-2 text-slate-900 dark:text-white cursor-pointer select-none"
            ...
            <nav className="hidden md:flex items-center gap-8">
              <button
                onClick={() => navigateTo(Screen.LANDING)}
                className="text-sm font-medium hover:text-primary transition-colors text-slate-600 dark:text-slate-300 hover:text-primary dark:hover:text-primary"
              >
                Home
              </button>
            ...
            <div className="flex items-center justify-end gap-4">
              <button
                ...
                className="hidden sm:flex text-sm font-medium hover:text-primary transition-colors text-slate-900 dark:text-white hover:text-primary dark:hover:text-primary"
              >
                Sign In
              </button>
              <button
