...
export function NotificationDropdown() {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      // Silently fail — polling should not surface errors to the user
    }
  };
                ...
                >
                  <div className="flex gap-3">
                    ...
                    <div className="flex-1">
                      <h4
                        className={`text-sm ${!n.isRead ? 'font-bold text-gray-900 dark:text-white' : 'font-medium text-gray-700 dark:text-gray-300'}`}
                      >
                        {n.title}
                      </h4>
