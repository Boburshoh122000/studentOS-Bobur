...
const cardCls =
  'bg-white dark:bg-[#1a1f2e] border border-gray-100 dark:border-gray-800 rounded-2xl p-6 mb-5 shadow-sm';
const actionBtnCls =
...
export default function UserProfile({ navigateTo }: NavigationProps) {
  ...
  return (
    <DashboardLayout currentScreen={Screen.PROFILE} navigateTo={navigateTo}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 md:py-14 space-y-0">
        {/* ═══ HEADER CARD ═══ */}
